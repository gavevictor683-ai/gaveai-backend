  ...
  try {
    ...
    */
    ...
    const corrections = {
      ...
      "aktyÃ¨l aktivite": "aktivite",
      "aktyÃ¨l konpetans": "konpetans",
      "aktyÃ¨l travay": "travay",

      "fonksyÃ²nÃ¨l": "fonksyonèl",
...
app.listen(
  ...
  () => {
    ...
    console.log(
      `Video credit cost: ${VIDEO_CREDIT_COST}`
    );
  }
);