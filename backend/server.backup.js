...
const { searchWeb, shouldUseWebSearch } = require("./services/webSearchService");
...
const corsOptions = {
origin: [
"[https://gavemoneytips.blogspot.com](https://gavemoneytips.blogspot.com)",
"http://localhost:3000"
],
...
if (
origin === "[https://gavemoneytips.blogspot.com](https://gavemoneytips.blogspot.com)" ||
...
webSearchUsed = searchResult.searchUsed;
webSources = searchResult.sources;
}

let aiReply = await generateAIResponse(userMessage, webSources);
...
sources: (Array.isArray(webSources) ? webSources : []).map((source) => ({
title: source?.title || "",
url: source?.url || "",
